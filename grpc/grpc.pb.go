...
type GrpcClient interface {
	Exchange(ctx context.Context, in *proto.Message, opts ...grpc.CallOption) (*proto.Message, error)
}
...
func (c *grpcClient) Exchange(ctx context.Context, in *proto.Message, opts ...grpc.CallOption) (*proto.Message, error) {
	out := new(proto.Message)
	err := c.cc.Invoke(ctx, "/grpc.Grpc/Exchange", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GrpcServer interface {
	Exchange(context.Context, *proto.Message) (*proto.Message, error)
...
func (UnimplementedGrpcServer) Exchange(context.Context, *proto.Message) (*proto.Message, error) {
...
func _Grpc_Exchange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(proto.Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GrpcServer).Exchange(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.Grpc/Exchange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GrpcServer).Exchange(ctx, req.(*proto.Message))
	}
...
var Grpc_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Exchange",
			Handler:    _Grpc_Exchange_Handler,
		},
	},
